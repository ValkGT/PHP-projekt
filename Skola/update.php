...
if(isset($_GET['updateid'])){
    ...
    if(isset($_POST["submit"])){
        ...
        $sql = "UPDATE `hraci` SET Meno='$Meno', Priezvisko='$Priezvisko', Vek='$Vek', Adresa='$Adresa' WHERE id=$id";
...
<body>
    <div class="container">
        <form method="post">
            ...
            <button type="submit" class="btn btn-primary" name="submit">Upraviť</button>
        </form>
    </div>
</body>
</html>
